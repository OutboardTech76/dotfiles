...
ResourcePref resources[] = {
    ...
    {"background-alt2",        STRING,    &selbgcolor},
    {"background",             STRING,    &urgbgcolor},
    {"white",                  STRING,    &normfgcolor},
    {"white",                  STRING,    &selfgcolor},
    {"pink",                   STRING,    &urgfgcolor},
    {"tabBefore",              STRING,    &before},
    {"tabAfter",               STRING,    &after},
    {"tabTitletrim",           STRING,    &titletrim},
